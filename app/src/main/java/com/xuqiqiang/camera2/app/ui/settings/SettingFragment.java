package com.xuqiqiang.camera2.app.ui.settings;
...
import com.xuqiqiang.camera2.app.utils.SupportInfoDialog;
...
/**
 * Created by xuqiqiang on 9/25/17.
 */
public class SettingFragment extends PreferenceFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mManger = new DeviceManager(getActivity(), null);
    ...
    private CameraSettings getSettingMgr() {
        if (mCameraSettings == null) {
            mCameraSettings = new CameraSettings(getActivity());
        }
        return mCameraSettings;

//        return CameraSettings.getInstance(getActivity().getApplicationContext());
...
//                .getCameraSettings(getActivity().getApplicationContext());
    ...
    private int setPictureFormatPref(String cameraId, String key) {
        ...
        picFormatPref.setSummary(picFormatPref.getEntry()); // supportFormatStr[0][index]);//
    ...
    private void setPictureSizePref(String cameraId, String picKey, int format) {
        ...
        String currentPicSize = getSettingMgr().getPictureSizeStr(cameraId, map, format);
